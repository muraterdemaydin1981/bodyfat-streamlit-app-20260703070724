...
with col1:
    ...
    weight = st.number_input("Kilo (kg)", min_value=100.0, max_value=300.0, value=170.0, step=0.1, help="Kilonuz (kg)")
    height = st.number_input("Boy (cm)", min_value=60.0, max_value=80.0, value=70.0, step=0.1, help="Boyunuz (cm)")
